...
import about from "../assets/img/section/about.jpg";
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="st-iconbox st-style1">
              ...
              <h2 class="st-iconbox-title">Mobile App Development</h2>
              <div class="st-iconbox-text">
                Developing and maintaining applications for mobile platforms
          ...
          <div class="col-lg-4 col-md-6">
            <div class="st-iconbox st-style1">
              ...
              <div class="st-iconbox-text">
                Designing user interfaces and experiences to ensure software is
                user-friendly and meets the needs of its audience.
              </div>
            </div>
            <div class="st-height-b30 st-height-lg-b30"></div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="st-iconbox st-style1">
              ...
              <div class="st-iconbox-text">
                Building and maintaining websites, including front-end (user
                interface) and back-end (server-side) development.
              </div>
            </div>
            <div class="st-height-b30 st-height-lg-b30"></div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="st-iconbox st-style1">
              ...
              <h2 class="st-iconbox-title">Data Science and Analytics</h2>
              <div class="st-iconbox-text">
                Designing, implementing, and managing databases to store and
          ...
          <div class="col-lg-4 col-md-6">
            <div class="st-iconbox st-style1">
              ...
              <h2 class="st-iconbox-title">Software Maintenance </h2>
              <div class="st-iconbox-text">
                Updating and fixing software to ensure it continues to work
                effectively.
              </div>
            </div>
            <div class="st-height-b0 st-height-lg-b30"></div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="st-iconbox st-style1">
              ...
              <h2 class="st-iconbox-title">Software Testing</h2>
              <div class="st-iconbox-text">
                Ensuring that the software is reliable, functional, and meets
